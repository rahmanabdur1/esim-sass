...
import { Sun, Moon, Monitor, Bell, Globe, Mail } from 'lucide-react';
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <main id="main-content" className="max-w-3xl flex-1 overflow-y-auto p-6 md:p-8">
        ...
        <p className="mb-8 text-sm text-muted-foreground">Manage your preferences</p>
        ...
        >
          <h2 id="appearance-heading" className="mb-4 font-semibold">
            Appearance
          </h2>
          <fieldset>
            <legend className="mb-3 text-sm text-muted-foreground">Choose your theme</legend>
            <div className="grid grid-cols-3 gap-3">
              {themes.map(({ value, label, icon: Icon }) => (
                <label
                  key={value}
                  className={`flex cursor-pointer flex-col items-center gap-2 rounded-lg border p-4 transition-all ${theme === value ? 'border-primary bg-primary/5 ring-2 ring-primary' : 'hover:bg-muted/50'}`}
                >
                  <input
                    type="radio"
                    name="theme"
        ...
        {/* Language */}
        <section aria-labelledby="language-heading" className="mb-6 rounded-xl border bg-card p-6">
          <h2 id="language-heading" className="mb-4 flex items-center gap-2 font-semibold">
        ...
        {/* Notifications */}
        <section aria-labelledby="notif-heading" className="mb-6 rounded-xl border bg-card p-6">
          <h2 id="notif-heading" className="mb-2 flex items-center gap-2 font-semibold">
          ...
          <div className="divide-y">
            <Toggle
              ...
              description="Receive order confirmations and updates by email"
            ...
            <Toggle
              ...
              description="Text messages for critical eSIM status changes"
            ...
            <Toggle
              ...
              description="Always notified about security events"
            ...
            <Toggle
              ...
              description="Deals, travel tips, and new plan announcements"
        ...
        {/* Data & Privacy */}
        <section aria-labelledby="data-heading" className="mb-6 rounded-xl border bg-card p-6">
          <h2 id="data-heading" className="mb-4 font-semibold">
            Data & Privacy
          </h2>
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              Download a copy of all data we have associated with your account.
            </p>
          </div>
        </section>
