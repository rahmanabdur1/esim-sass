...
export const useSessionSecurityStore = create<SessionSecurityStore>()(
  persist(
    (set, get) => ({
      ...
      recordActivity: () => set({ lastActivity: Date.now(), isWarning: false, isTimedOut: false, warningDismissed: false }),
      ...
      resetSession:   ()  => set({
        lastActivity: Date.now(), isWarning: false, isTimedOut: false,
        warningDismissed: false, sessionId: null, loginAt: null,
      }),
    }),
    {
