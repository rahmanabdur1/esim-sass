...
const STEPS = [
  {
    ...
    content:
      'Stay connected in 190+ countries without swapping SIM cards. Your eSIM is activated instantly and works alongside your existing number.',
  ...
  },
  {
    ...
    content:
      'Browse plans by country or region. Filter by data size, validity, and price. Compare plans side-by-side to find the best value for your trip.',
  ...
  },
  {
    ...
    content:
      'Add a payment method once and reuse it for all future purchases. We support Visa, Mastercard, PayPal, Apple Pay, and Google Pay.',
  ...
  },
  {
    ...
    content:
      'After purchase, scan the QR code in your phone settings under "Cellular" or "Mobile Data". Your eSIM profile installs automatically.',
  ...
  },
  {
    ...
    content:
      'Enable data roaming when you land and your eSIM connects automatically to local networks. Monitor usage from your dashboard anytime.',
...
export function OnboardingWizard({ onClose }: OnboardingWizardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Step content */}
      <div className="mb-6 min-h-56 overflow-hidden">
        <AnimatePresence custom={direction} mode="wait">
          ...
          >
            {/* Icon */}
            <div
              className={`flex h-20 w-20 items-center justify-center rounded-2xl ${current.color} mb-5`}
            >
            ...
            <h2 id="onboarding-title" className="mb-3 font-display text-xl font-bold">
              {current.title}
            </h2>
            <p
            ...
            {/* Tip */}
            <div className="w-full rounded-lg bg-muted/50 px-4 py-2.5 text-xs text-muted-foreground">
              {current.tip}
            </div>
          </motion.div>
        </AnimatePresence>
