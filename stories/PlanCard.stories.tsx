...
const mockPlan: Plan = {
  ...
  network: 'NTT Docomo',
  coverage: ['JP'],
  features: ['4G/LTE', 'Tethering', 'No throttling'],
  isPopular: true,
  isBestValue: false,
  country: {
    id: 'jp',
...
export const BestValue: Story = {
  args: { plan: { ...mockPlan, isBestValue: true, isPopular: false, name: 'Best Value Plan' } },
};
export const WithCallback: Story = {
  args: { plan: mockPlan, onSelect: (p) => alert(`Selected: ${p.name}`) },
};
export const LargeData: Story = {
  args: { plan: { ...mockPlan, data: 50, validity: 90, price: 24.99, name: 'Japan Power User' } },
};
