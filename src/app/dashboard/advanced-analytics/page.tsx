...
const SPENDING_DATA = [
  { month: 'Aug', spent: 12.99 },
  { month: 'Sep', spent: 8.99 },
  { month: 'Oct', spent: 24.97 },
  { month: 'Nov', spent: 6.99 },
  { month: 'Dec', spent: 19.98 },
  { month: 'Jan', spent: 14.99 },
];
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <main id="main-content" className="flex-1 overflow-y-auto p-6 md:p-8">
        <h1 className="mb-1 font-display text-2xl font-bold">Advanced Analytics</h1>
        ...
        <div className="mb-6 grid grid-cols-1 gap-6 xl:grid-cols-3">
          {/* Data Usage Chart */}
          <section
            className="rounded-xl border bg-card p-6 xl:col-span-2"
            aria-labelledby="usage-chart-heading"
          >
            <div className="mb-5 flex items-center justify-between">
              <h2 id="usage-chart-heading" className="font-semibold">
                Data Usage
              </h2>
          ...
          >
            <h2 id="country-chart-heading" className="mb-5 font-semibold">
              Top Destinations
            </h2>
            <div className="mb-4 h-44" role="img" aria-label="Country usage distribution pie chart">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    data={COUNTRY_DATA}
        ...
        <section className="rounded-xl border bg-card p-6" aria-labelledby="spending-chart-heading">
          <h2 id="spending-chart-heading" className="mb-5 font-semibold">
            Monthly Spending
          </h2>
