        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
          ...
          >
                ...
                <div className="mt-2" aria-label={`Password strength: ${strength.label}`}>
                  <div className="mb-1 flex gap-1">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className={`h-1 flex-1 rounded-full transition-colors ${i <= strength.score / 1.5 ? strength.color : 'bg-white/10'}`}
                      />
                    ))}
                  </div>
            ...
            <Button
              ...
              leftIcon={!isPending ? <UserPlus className="h-4 w-4" /> : undefined}
            >
          ...
          <p className="mt-6 text-center text-xs text-slate-500">
            ...
            <Link href={ROUTES.TERMS} className="text-blue-400 hover:underline">
              Terms
            </Link>{' '}
            and{' '}
            <Link href={ROUTES.PRIVACY} className="text-blue-400 hover:underline">
              Privacy Policy
            </Link>
            .
          </p>
