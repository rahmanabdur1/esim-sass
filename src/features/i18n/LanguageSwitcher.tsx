...
export const useI18nStore = create<I18nStore>()(
  persist(
    ...
    { name: 'i18n-locale', storage: createJSONStorage(() => localStorage) }
  )
);
        ...
        {open && (
          <>
            ...
            <motion.ul
              ...
              className="absolute right-0 top-full mt-1 z-50 w-44 rounded-xl border bg-popover shadow-lg py-1 overflow-hidden"
            >
              {LOCALES.map((loc) => (
