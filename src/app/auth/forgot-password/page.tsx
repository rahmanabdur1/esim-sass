        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
          ...
          {sentEmail ? (
            ...
            >
              ...
              <p className="mb-2 text-sm text-slate-400">We sent a password reset link to:</p>
              <p className="mb-6 text-sm font-semibold text-white">{sentEmail}</p>
              <p className="mb-8 text-xs text-slate-500">
                Didn't receive it? Check your spam folder. The link expires in 15 minutes.
              </p>
              <Button
                variant="outline"
                className="mb-3 w-full border-white/10 text-white hover:bg-white/10"
              ...
              <Link
                href={ROUTES.LOGIN}
                className="flex items-center justify-center gap-1 text-sm text-blue-400 transition-colors hover:text-blue-300"
              >
            ...
            <>
              <h1 className="mb-1 text-2xl font-bold text-white">Forgot your password?</h1>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="flex h-11 w-full rounded-lg border border-white/10 bg-white/5 pl-10 pr-4 text-sm text-white transition-colors placeholder:text-slate-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400"
                      {...register('email')}
                    />
                  </div>
                  {errors.email && (
                    <p id="fp-email-error" role="alert" className="mt-1 text-xs text-red-400">
              ...
              <div className="mt-6 text-center">
                <Link
                  href={ROUTES.LOGIN}
                  className="inline-flex items-center gap-1 text-sm text-blue-400 transition-colors hover:text-blue-300 focus-visible:underline focus-visible:outline-none"
                >
                  <ArrowLeft className="h-3.5 w-3.5" /> Back to Sign In
                </Link>
              </div>
