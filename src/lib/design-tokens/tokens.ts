...
export const spacingTokens = {
  ...
  40: '10rem', 48: '12rem', 56: '14rem', 64: '16rem', 72: '18rem',
  80: '20rem', 96: '24rem',
} as const;
...
export const zIndexTokens = {
  hide:    -1, auto: 'auto', base: 0, raised: 1, dropdown: 10,
  sticky:  20, overlay: 30, modal: 40, popover: 50, toast: 60, tooltip: 70,
} as const;

export const breakpointTokens = {
  xs: '320px', sm: '640px', md: '768px', lg: '1024px',
