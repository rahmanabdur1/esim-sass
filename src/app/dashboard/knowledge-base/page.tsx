  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <main id="main-content" className="flex-1 overflow-y-auto">
        {/* Hero search */}
        <div className="bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 px-6 py-12 text-center text-white md:px-8">
          <BookOpen className="mx-auto mb-3 h-10 w-10 text-blue-400" aria-hidden="true" />
          <h1 className="mb-2 font-display text-2xl font-bold md:text-3xl">How can we help?</h1>
        ...
        <div className="mx-auto max-w-5xl p-6 md:p-8">
          ...
          >
            ...
            {CATEGORIES.map((cat) => (
              ...
              >
                <div
                  className={`mx-auto mb-2 flex h-9 w-9 items-center justify-center rounded-lg ${cat.color}`}
                >
          ...
          <div className="mb-10 space-y-3">
            {isLoading ? (
              ...
              <div className="rounded-xl border-2 border-dashed py-16 text-center">
                ...
                <p className="mb-1 font-semibold">No articles found</p>
              ...
              filtered.map((article, i) => (
                <motion.article
                  ...
                  className="group cursor-pointer rounded-xl border bg-card p-5 transition-shadow hover:shadow-sm"
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="min-w-0 flex-1">
                      <h2 className="mb-1 text-sm font-semibold transition-colors group-hover:text-primary">
                        {article.title}
                      </h2>
          ...
          {/* Contact CTA */}
          <div className="flex flex-col items-center justify-between gap-4 rounded-xl border bg-muted/30 p-6 sm:flex-row">
            <div className="flex items-center gap-3">
              <MessageCircle className="h-8 w-8 flex-shrink-0 text-primary" aria-hidden="true" />
              <div>
