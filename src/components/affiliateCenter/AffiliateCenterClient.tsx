...
const LINKS: AffiliateLink[] = [
  {
    id: '1',
    campaign: 'Blog — Japan Guide',
    url: 'esimplatform.com/r/abc123',
    clicks: 1240,
    conversions: 87,
    earnings: 217.5,
  ...
  {
    id: '2',
    campaign: 'YouTube — Travel Vlog',
    url: 'esimplatform.com/r/def456',
    clicks: 3890,
    conversions: 234,
    earnings: 585.0,
  ...
  {
    id: '4',
    campaign: 'Newsletter — Dec Promo',
    url: 'esimplatform.com/r/jkl012',
    clicks: 567,
    conversions: 29,
    earnings: 72.5,
  ...
  const linkColumns: ColumnDef<AffiliateLink>[] = useMemo(
    () => [
      { key: 'campaign', header: 'Campaign', sortable: true, getValue: (r) => r.campaign },
      {
        key: 'url',
        header: 'Link',
        cell: (row) => <code className="rounded bg-muted px-1.5 py-0.5 text-xs">{row.url}</code>,
      },
      {
        key: 'clicks',
        header: 'Clicks',
      ...
      },
      {
        ...
        cell: (row) => (
          <span className="font-semibold text-green-600">{formatCurrency(row.earnings)}</span>
        ),
      },
      {
        key: 'action',
      ...
      <main id="main-content" className="min-h-screen pt-16">
        <section className="bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 py-16 text-white">
          <div className="container mx-auto px-4 text-center md:px-6">
            ...
            <h1 className="mb-3 font-display text-3xl font-bold md:text-4xl">Affiliate Center</h1>
            <p className="mx-auto max-w-xl text-slate-300">
              Earn commission for every customer you refer. Create custom links, track performance,
        ...
        <div className="container mx-auto max-w-5xl px-4 py-12 md:px-6">
          ...
          <div className="mb-8 grid grid-cols-2 gap-4 lg:grid-cols-4">
            {[
              ...
              >
                <div
                  className={`flex h-10 w-10 items-center justify-center rounded-lg ${kpi.color} mb-3`}
                >
          ...
          <section
            ...
            aria-labelledby="clicks-chart-heading"
          >
            <h2 id="clicks-chart-heading" className="mb-5 font-semibold">
              Clicks — Last 7 Days
            </h2>
          ...
          >
            <h2 id="generate-heading" className="mb-4 font-semibold">
          ...
          <section aria-labelledby="links-heading">
            ...
            />
            <p className="mt-2 text-xs text-muted-foreground">Click any row to copy its link.</p>
          </section>

          {/* Payout info */}
          <div className="mt-8 flex flex-wrap items-center justify-between gap-4 rounded-xl border bg-muted/30 p-6">
            <div>
              <p className="text-sm font-semibold">Next payout</p>
              <p className="text-xs text-muted-foreground">
                Payouts are processed monthly via PayPal or bank transfer, minimum $50.
              </p>
            </div>
