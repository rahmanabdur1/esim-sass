  ...
  return (
    <>
      ...
      <main id="main-content" className="min-h-screen pt-16">
        ...
        <section className="bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 py-20 text-center text-white">
          <Globe className="mx-auto mb-4 h-12 w-12 text-blue-400" aria-hidden="true" />
          <h1 className="mb-3 font-display text-4xl font-bold md:text-5xl">Global Coverage</h1>
        ...
        <div className="container mx-auto space-y-14 px-4 py-16 md:px-6">
          ...
          {byRegion.map((region) => (
            ...
            >
              <h2
                ...
                className="mb-6 border-b pb-3 font-display text-2xl font-bold"
              >
                {region.name}
              </h2>
