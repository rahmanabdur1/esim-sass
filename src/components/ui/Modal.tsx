        ...
        <>
          ...
          <div className="pointer-events-none fixed inset-0 z-50 flex items-center justify-center p-4">
            <motion.div
              ...
              className={cn(
                'pointer-events-auto w-full rounded-2xl border bg-card shadow-2xl',
                SIZE_CLASSES[size],
                className,
              )}
            ...
            >
              ...
              <div className={cn(!title && !showCloseButton ? 'p-6' : 'px-6 pb-6')}>{children}</div>
            </motion.div>
          </div>
        </>
      )}
    ...
    >
      <div className="mt-2 flex justify-end gap-3">
        <button
          onClick={onClose}
          disabled={isLoading}
          className="rounded-md border px-4 py-2 text-sm font-medium transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50"
        >
          {cancelLabel}
        </button>
        <button
